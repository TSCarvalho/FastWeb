...
class WCMp_Product {
    ...
    /**
     * Vendor Tem um problema com isso! option
     */
    function add_report_abuse_link() {
        ...
        if (isset($report_abuse_text['report_abuse_text']) && !empty($report_abuse_text['report_abuse_text'])) {
            ...
            $display_text = __('Tem um problema com isso!', 'dc-woocommerce-multi-vendor');
        }
        if ($is_display) {
            ?>
            <a href="#" id="report_abuse"><?php echo $display_text; ?></a><br>
            <div id="report_abuse_form" class="simplePopup"> 
                <h3 class="wcmp-abuse-report-title"><?php _e('Diga o que aconteceu com esse produto', 'dc-woocommerce-multi-vendor') . ' ' . the_title(); ?> </h3>
