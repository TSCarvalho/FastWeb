        ...
        $settings_tab_options = array("tab" => "{$this->tab}",
            ...
            "sections" => array(
                "default_settings_section" => array("title" => '', // Section one
                    "fields" => array(
                        "sold_by_catalog" => array('title' => __('Enable "Vendido por"', 'dc-woocommerce-multi-vendor'), 'type' => 'checkbox', 'id' => 'sold_by_catalogg', 'label_for' => 'sold_by_catalogg', 'text' => stripslashes(__('On shop page.', 'dc-woocommerce-multi-vendor')), 'name' => 'sold_by_catalog', 'value' => 'Enable'), // Checkbox
                        ...
                        "sold_by_text" => array('title' => __('"Vendido por" label', 'dc-woocommerce-multi-vendor'), 'type' => 'text', 'id' => 'sold_by_textt', 'label_for' => 'sold_by_textt', 'name' => 'sold_by_text', 'desc' => stripslashes(__('Add the text you want to replace the phrase \"Vendido por {vendor name}\".', 'dc-woocommerce-multi-vendor'))), // Text
                        ...
                        "show_report_abuse" => array('title' => __('Show "Tem um problema com isso!" link', 'dc-woocommerce-multi-vendor'), 'type' => 'select', 'id' => 'show_report_abuse', 'name' => 'show_report_abuse', 'label_for' => 'show_report_abuse', 'desc' => stripslashes(__('A "Tem um problema com isso!" link will appear in single product page.', 'dc-woocommerce-multi-vendor')), 'options' => array('all_products' => __('All Products', 'dc-woocommerce-multi-vendor'), 'only_vendor_products' => __("Only for Vendor's Products", 'dc-woocommerce-multi-vendor'), 'disable' => __('Disable', 'dc-woocommerce-multi-vendor'))), // select
                        "report_abuse_text" => array('title' => __('"Tem um problema com isso!" label', 'dc-woocommerce-multi-vendor'), 'type' => 'text', 'id' => 'report_abuse_text', 'label_for' => 'report_abuse_text', 'name' => 'report_abuse_text'), // Text
