...
* Fixed: Vendido por incorrectly showing in cart for variations
...
* Added: Template for Vendido por in shop loop #324
...
* Added: Option to disable Vendido por #236
* Added: Initial sub order management code #196 thanks Spreeuw 
* Fixed: Vendido por meta removal
...
* Fixed: Vendido por:Name spaces issue #256
...
* Fixed: Vendido por label issues with WC 2.5 #250
...
* Fixed: Vendido por formatting issue #248
...
* Added: Vendido por label option
...
* Added: Option to change Vendido por vendor name #106
...
* Added: CSS class for Vendido por (classes same as filters in those files)
...
* Added new filters to change Vendido por text see Knowledge base for details
* Added Vendido por to product loop for archive-product.php, see knowledge base on how to disable or change this
* Added new option to hide "Featured product" from vendors
* Added Vendido por Filter as per #3
