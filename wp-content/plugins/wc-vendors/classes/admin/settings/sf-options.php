...
$options[ ] = array(
	...
	'desc'    => __( 'Select what will be displayed for the Vendido por text throughout the store.', 'wcvendors' ),
...
$options[ ] = array(
	'name' => __( 'Vendido por', 'wcvendors' ),
	'desc' => __( 'Enable Vendido por labels', 'wcvendors' ),
	'tip'  => __( 'This will enable or disable the Vendido por labels.', 'wcvendors' ),
	'id'   => 'sold_by',
	'type' => 'checkbox',
	'std'  => true,
);
...
$options[ ] = array(
	'name' => __( 'Vendido por Label', 'wcvendors' ),
	'desc' => __( 'The Vendido por label used on the site and emails.', 'wcvendors' ),
	'id'   => 'sold_by_label',
	'type' => 'text',
	'std'  => __( 'Vendido por', 'wcvendors' ),
);
