...
if ( ! class_exists('SLP_Upgrade') ) {
	...
	class SLP_Upgrade extends SLPlus_BaseClass_Object {
		...
		private $legacy_options = array(
			...
			'sl_google_map_country'          => array( 'key' => 'default_country' , 'type' => 'nojs' , 'callback' => 'sanitize_key' , 'since' => '4.5-alpha-01' ) ,
			...
			'sl_num_initial_displayed'       => array( 'key' => 'initial_results_returned' , 'type' => 'nojs' , 'since' => '4.0.033' ) ,
