...
class SLPlus_Data extends SLPlus_BaseClass_Object {
     ...
     *
     * TODO: Make this private when ER, EXP, and SME remove the call.  No longer needed as this is called via initialize() whenever this class is active.
     */
    ...
    function get_Value($commandList, $params = array() ) {
    	...
    	if ( ! empty( $params ) ) {
		    $sql_statement = $this->db->prepare( $this->get_SQL( $sql_statement ) , $params );
	    }
