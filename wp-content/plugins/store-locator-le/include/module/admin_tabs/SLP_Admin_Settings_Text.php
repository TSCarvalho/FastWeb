<?php
if ( ! class_exists( 'SLP_Admin_Settings_Text' ) ) {
	/**
	...
	class SLP_Admin_Settings_Text {
		...
		private function set_text_strings() {
			...
			$this->text_strings['description']['label_directions'] =
				__( 'What to put on the search Resultados para the directions link. ', 'store-locator-le' );
			...
			$this->text_strings['description']['label_hours'] =
				__( 'What to put in search Resultados para hours. ', 'store-locator-le' ) .
				$this->text_strings['changes_location_tab_label'];
			...
			$this->text_strings['description']['style'      ] = __( 'How do you want the locator to look and function? ', 'store-locator-le' ) .
			                                                    ...
			                                                    __( 'Each style changes different global settings in Store Locator Plus, overwriting any modifications you may have made previously. ' , 'store-locator-le' );
