	...
	public function add_tabs() {
		...
		$screen->add_help_tab( array(
			...
			'content'   =>
				...
				'<p>' . sprintf(
					__( 'For further assistance with WooCommerce core you can use the <a href="%1$s">community forum</a>. If you need help with premium extensions Vendido por WooCommerce, please <a href="%2$s">use our helpdesk</a>.', 'woocommerce' ),
