	...
	<form action="<?php echo esc_attr($formUrl); ?>" method="post" enctype="multipart/form-data" data-route-id="<?php echo $route->getId(); ?>">
		...
		<div class="cmloc-field cmloc-images">
			...
			<div class="cmloc-images-add">
				...
				<a href="#" class="cmloc-images-add-btn"><?php echo Labels::getLocalized('dashboard_image_add'); ?></a>
			</div>
		</div>
		...
		<div class="form-summary">
			<input type="hidden" name="<?php echo esc_attr(DashboardController::EDITOR_NONCE); ?>" value="<?php echo esc_attr($nonce); ?>" class="cmloc-nonce" />
