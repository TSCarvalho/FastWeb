...
<?php
	...
	public function cache_oembed( $post_ID ) {
		...
		/**
		 * Filters the array of post types to cache oEmbed Resultados para.
		 *
		 * @since 2.9.0
		 *
		 * @param array $post_types Array of post types to cache oEmbed Resultados para. Defaults to post types with `show_ui` set to true.
		 */
